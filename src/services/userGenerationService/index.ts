...
import { UserGenerationService } from "./types";

// Create and export the service implementation
const createUserGenerationService = (): UserGenerationService => {
  return {
...
export const userGenerationService = createUserGenerationService();
